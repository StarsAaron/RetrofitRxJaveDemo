package com.aaron.retrofitlibrary.net;

import android.content.Context;
import android.text.TextUtils;

import com.aaron.retrofitlibrary.BuildConfig;
import com.aaron.retrofitlibrary.net.interceptor.CacheInterceptor;
import com.aaron.retrofitlibrary.net.interceptor.logging.Level;
import com.aaron.retrofitlibrary.net.interceptor.logging.LoggingInterceptor;
...
public class RetrofitClientDemo {
    ...
    public static RetrofitClientDemo getInstance(Context mContext) {
        SingletonHolder.INSTANCE.setContext(mContext);
